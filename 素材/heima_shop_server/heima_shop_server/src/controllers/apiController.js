...
exports.getlunbo = (req, res) => {
  let resObj = {
    status: successState, message: [{
		id: 1,
      url: 'https://gitee.com/xiaowu_wang/pic/raw/master/u=2078698033,3051635948&fm=26&gp=0.jpg',
      img: 'http://img10.360buyimg.com/pop/s590x470_jfs/t1/108106/32/10341/100111/5e7d6137E2b760a74/5510064005929740.jpg.webp'
		// img: 'https://gitee.com/xiaowu_wang/pic/raw/master/u=2078698033,3051635948&fm=26&gp=0.jpg'
    }, {
		id: 2,
      url: 'https://gitee.com/xiaowu_wang/pic/raw/master/u=3462170093,2178394627&fm=26&gp=0.jpg',
      img: 'http://img14.360buyimg.com/pop/s590x470_jfs/t1/103548/26/16527/72754/5e7d54d7E548d2a6c/2fea52386a9bca25.jpg.webp'
		// img: 'https://gitee.com/xiaowu_wang/pic/raw/master/u=3462170093,2178394627&fm=26&gp=0.jpg'
    }, {
		id: 3,
      url: 'https://gitee.com/xiaowu_wang/pic/raw/master/322502942.jpeg',
       img: 'http://img13.360buyimg.com/pop/s590x470_jfs/t1/95654/10/16786/66736/5e7db7c5Edff9ce7f/5ccf747f742cc2a6.jpg.webp'
		//img: 'https://gitee.com/xiaowu_wang/pic/raw/master/322502942.jpeg'
    }]
  }
...
exports.getnewslist = (req, res) => {
   ...
   */
  let sql = " SELECT a.id,a.title,a.add_time,left(zhaiyao,25) as zhaiyao,a.click,if(a.id!=95,concat('" + domain + "',a.img_url),a.img_url) as img_url FROM dt_article a where a.img_url > '' and a.channel_id = 6 limit 0,10 "
...
exports.getgoods = (req, res) => {
  ...
  ,img_url:图片地址，前缀是7牛云存储域名
   */
  let sql = `SELECT a.id,a.title,a.add_time,left(a.zhaiyao,25) as zhaiyao,a.click,if(a.id!=95,concat('" + domain + "',a.img_url),a.img_url) as img_url,b.sell_price,b.market_price,b.stock_quantity FROM dt_article as a,dt_article_attribute_value b where a.id = b.article_id and a.channel_id = 7 limit ${skipcount},${pagesize} `
...
exports.getimage = (req, res) => {
  ...
  // 2.0 执行查询操作
  let sql = `select article_id as article_id,thumb_path as src  from dt_article_albums where article_id =${newid}`
